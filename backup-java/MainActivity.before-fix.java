            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    String urlString =
                            ...
                            "6b3b4b8f0c9f7f0b5c5b5f8e5d5f5f5f5f5f5f5f/server.jar";
                    ...
                    FileOutputStream output =
                            new FileOutputStream(
                                    new java.io.File(folder, "minecraft.jar")
                            );
...
while ((manifestLength = manifestInput.read(manifestBuffer)) != -1) {
    manifestOutput.write(manifestBuffer, 0, manifestLength);
}
...
String manifestJson =
        manifestOutput.toString("UTF-8");

JSONObject manifest =
        new JSONObject(manifestJson);
...
String versionJson =
        versionOutput.toString("UTF-8");

JSONObject versionData =
        new JSONObject(versionJson);
...
return "Minecraft " + selectedVersion +
        " دانلود شد!";
